...
export const MOCK_ITEMS = [
    ...
    { id: '4', name: 'Garlic Naan', price: 60, category: 'Breads', isVeg: true, isPopular: true, description: 'Soft leavened bread with a buttery garlic glaze.', image: '/images/garlic_naan.jpg', cuisine: 'North Indian', pairingTags: ['bread'] },
    { id: '5', name: 'Gulab Jamun', price: 90, category: 'Desserts', isVeg: true, isPopular: true, description: 'Two pieces of traditional milk-solid based sweets syrup.', image: '/images/gulab_jamun.jpg', cuisine: 'North Indian', pairingTags: ['dessert'] },
    { id: '6', name: 'Chicken Biryani', price: 320, category: 'Main Course', isVeg: false, isPopular: true, description: 'Fragrant basmati rice cooked with spicy chicken and herbs.', image: '/images/chicken_biryani.jpg', cuisine: 'North Indian', pairingTags: ['main'] },
    ...
    { id: '9', name: 'Veg Samosa', price: 50, category: 'Appetizers', isVeg: true, isPopular: true, description: 'Crispy pastry filled with spiced potatoes and peas.', image: '/images/samosa.jpg', cuisine: 'North Indian', pairingTags: ['appetizer', 'snack'] },
    ...
    { id: '14', name: 'Rasmalai', price: 110, category: 'Desserts', isVeg: true, isPopular: true, description: 'Soft cottage cheese dumplings in sweetened saffron milk.', image: '/images/ras_malai.png', cuisine: 'North Indian', pairingTags: ['dessert'] },
    { id: '15', name: 'Masala Tea', price: 40, category: 'Beverages', isVeg: true, isPopular: true, description: 'Traditional Indian spiced tea with milk.', image: '/images/masalatea.png', cuisine: 'Beverages', pairingTags: ['beverage'] },
    ...
    { id: '17', name: 'Gobi Manchurian', price: 210, category: 'Appetizers', isVeg: true, isPopular: true, description: 'Deep-fried cauliflower tossed in spicy Indo-Chinese sauce.', image: '/images/gobi_manchurian.jpg', cuisine: 'Indo-Chinese', pairingTags: ['appetizer', 'side'] },
